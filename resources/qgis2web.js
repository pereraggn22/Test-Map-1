...
map.getView().fit([8661374.858894, 633576.472191, 9206903.848646, 983249.260495], map.getSize());
    ...
    element: (() => {
        ...
        if (60 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'The web map shows the main transpotation routes and wateways';
            }
